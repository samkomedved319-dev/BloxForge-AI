                  ...
                  {!connected ? (
                    ...
                    >
                      <p className="text-sm text-muted-foreground">
                        Pair this browser session with the BloxForge plugin in Roblox
                        Studio. The AI chat stays here — the plugin just syncs your
                        selected script and inserts generated code.
                      </p>
                      ...
                      <div className="mt-5 space-y-2.5">
                        ...
                        <Step n={2}>
                          Paste this pairing code + your BloxForge server URL.
                        </Step>
                        <Step n={3}>Click <b>Connect</b> in the plugin.</Step>
                      </div>
                    ...
                    >
                      ...
                      <h3 className="font-display text-xl font-bold">Studio connected</h3>
